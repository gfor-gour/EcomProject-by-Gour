...
function ReviewGrid(){
    ...
    return <div ref={containerRef} className="relative -mx-4 mt-16 grid h-[49rem]
    ...
    sm:mt-20 md:grid-cols-2 lg:grid-cols-3" >
        ...
        (<>
            ...
            reviewClassName={ 
                (reviewIndex) => reviewIndex >= column2.length? "lg:hidden" : ""
            }
            msPerPixel={15}
            />
...
export function Reviews(){
    return(
        ...
        alt="absolute select-none hidden xl:block -left-32 top-1/3" />
